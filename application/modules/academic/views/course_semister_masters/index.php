...
$(document).on('click','.delete-record',function(e){
                    e.preventDefault();
                    var data={'semister_id':$(this).data('semister_id')}
                    ...
                    BootstrapDialog.show({
                        ...
                        buttons: [{
                                ...
                                action: function (dialog) {
                                    $.ajax({
                                        url: '<?=APP_BASE?>academic/course_semister_masters/delete',
                                        method: 'POST',
                                        data: data,
...
//export raw data as excel 
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('academic/course_semister_masters/export_grid_data') ?>",
                data: param,
                dataType: 'json'
            }).done(function (data) {
