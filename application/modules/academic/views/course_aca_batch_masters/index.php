...
//delete record
        ...
        $(document).on('click', '.delete-record', function (e) {
            e.preventDefault();
            var data = {'course_aca_batch_id': $(this).data('course_aca_batch_id')}
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: '<?= APP_BASE ?>academic/course_aca_batch_masters/delete',
                                method: 'POST',
                                data: data,
...
//export raw data as excel 
        ...
        $(document).on('click', '#export_table_xls', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('academic/course_aca_batch_masters/export_grid_data') ?>",
                data: param,
                dataType: 'json'
            }).done(function (data) {
