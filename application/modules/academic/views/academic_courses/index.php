...
//delete record
        ...
        $(document).on('click', '.delete-record', function (e) {
            e.preventDefault();
            var data = {'academic_course_id': $(this).data('academic_course_id')}
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: '<?= APP_BASE ?>academic/academic_courses/delete',
                                method: 'POST',
                                data: data,
...
//export raw data as excel 
        ...
        $(document).on('click', '#export_table_xls', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('academic/academic_courses/export_grid_data') ?>",
                data: param,
                dataType: 'json'
            }).done(function (data) {
