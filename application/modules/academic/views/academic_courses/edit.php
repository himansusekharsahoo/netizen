<div class="col-sm-12">
    ...
    $form_action = "/academic/academic_courses/edit";
    echo form_open($form_action, $form_attribute);
    ?>
    <?php
    $attribute = array(
        "name" => "academic_course_id",
        "id" => "academic_course_id",
        "class" => "form-control",
        "title" => "",
        "required" => "",
        "type" => "hidden",
        "value" => (isset($data["academic_course_id"])) ? $data["academic_course_id"] : ""
    );
    echo form_error("academic_course_id");
