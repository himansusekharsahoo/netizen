    ...
    <div class="col-sm-12 no-pad">
        ...
        <div class="col-sm-6 no-pad">
            <div class="pull-right">                
                ...
                <span><a href="<?=base_url('employee-upload')?>" class="btn btn-default pannel_button pannel_button_w90 ">Cancel</a></span>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.delete-record', function (e) {
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: 'employee-upload-delete-row',
                                method: 'POST',
                                data: data,
        ...
        $(document).on('click', '#import_data', function () {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('employee-upload-import') ?>",                
                dataType: 'json'
            }).done(function (data) {
