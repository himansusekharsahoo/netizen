...
<div class="row-fluid">
    <div class="col-sm-6 col_centered">
        ...
        <div class="row-fluid marginT10 marginB10">
            <a href="uploads/upload_templates/course_academic_batch_upload_template.xlsx" class="chm_link">Download Template</a>
        </div>        
        <div class="row">
            <div class="form-group ">
                <form action="course-academic-batch-upload-process" enctype="multipart/form-data" method="post" name="upload_utility_form" id="upload_utility_form">
                    <div class="col-sm-12">
