...
//delete record
        ...
        $(document).on('click', '.delete-record', function (e) {
            e.preventDefault();
            var data = {'student_parent_id': $(this).data('student_parent_id')}
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                        ...
                        action: function (dialog) {
                            $.ajax({
                                url: '<?= APP_BASE ?>student/student_parent_profiles/delete',
                                method: 'POST',
                                data: data,
...
//export raw data as excel 
        ...
        $(document).on('click', '#export_table_xls', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('student/student_parent_profiles/export_grid_data') ?>",
                data: param,
                dataType: 'json'
            }).done(function (data) {
