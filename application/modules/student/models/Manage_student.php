 ...
 * @created :10/08/2018
 */
class Manage_student extends CI_Model {
     ...
     * @created:10/08/2018
     */
    public function get_student_datatable($data = null, $export = null, $tableHeading = null, $columns = null) {
    ...
    /**
     * @param              : $data
     * @desc               : save student profile data
     * @return             :
     * @author             :
     * @created:10/08/2018
     */
    public function save($data) {
        if ($data) :
            ...
            $this->db->insert("rbac_users", $student_user_data);
     ...
     * @created:10/08/2018
     */
    public function get_student_data($columns = null, $conditions = null, $limit = null, $offset = null) {
        if (!$columns) {
